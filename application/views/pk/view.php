...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/pk/simpan",
			data	: string,
			cache	: false,
...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/pk/ajukan",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
	...
	$("#hapus").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/pk/hapus",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
...
//		$data = $this->model_data->data_pk($username);
		$data = $this->model_data->data_pk("admin",$username);				
