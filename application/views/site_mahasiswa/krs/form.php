...
$(document).ready(function(){
	...
	function cari_data(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/site_mahasiswa/krs/cari_data",
			data	: string,
			cache	: false,
			success	: function(data){
	...
	$("#cetak").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/site_mahasiswa/krs/cetak_krs",
			data	: string,
			cache	: false,
			success	: function(data){
				if(data=='Sukses'){
					window.location.assign("<?php echo site_url();?>/site_mahasiswa/krs/print_krs");
				}else{
					$.gritter.add({
						title: 'Peringatan..!!',
						text: data,
