...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/data_collect/simpan",
			data	: string,
			cache	: false,
...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/data_collect/ajukan",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
	...
	$("#hapus").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/data_collect/hapus",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
...
function editData(ID){
	...
	$.ajax({
		type	: "POST",
		url		: "<?php echo site_url(); ?>site_user/data_collect/cari",
		data	: "cari="+cari,
		dataType: "json",
		success	: function(data){
			//alert(data.ref);
...
//		$data = $this->model_data->data_data_collect($username);
		$data = $this->model_data->data_data_collect("user",$username);				
		$i=1;
        ...
        <tr>
           ...
           <td class="center"><?php 
            ...
            <td style="text-align:right">  <?php echo number_format($dt->nominal,2);?></td>
        ...
        <div class="row-fluid">
            <form class="form-horizontal" name="my-form" id="my-form">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="surat_permohonan" id="surat_permohonan" class="span5" >
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="dokumen_pendukung_lain" id="dokumen_pendukung_lain" class="span5" >
                        	<option value="1" selected="selected">Ada</option>
                            <option value="2">Tidak Ada</option>
                            <option value="3">Ada Dengan Catatan</option>
                        </select>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="lap_keuangan_2thn_terakhir" id="lap_keuangan_2thn_terakhir" class="span5" >
                        	<option value="1" selected="selected">Ada</option>
                            <option value="2">Tidak Ada</option>
                            <option value="3">Ada Dengan Catatan</option>
                        </select>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="agunan" id="agunan" class="span5" >
                        	<option value="1" selected="selected">Ada</option>
                            <option value="2">Tidak Ada</option>
                            <option value="3">Ada Dengan Catatan</option>
                        </select>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    	 ...
                    	 <input list="kd_daerah_select" name="kd_daerah" id="kd_daerah">
						<datalist id="kd_daerah_select">
							 <?php
                        ...
                        <!-- <select name="kd_daerah" id="kd_daerah" class="span6">
