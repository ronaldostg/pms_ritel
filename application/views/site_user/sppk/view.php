...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/sppk/simpan",
			data	: string,
			cache	: false,
...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/sppk/ajukan",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
	...
	$("#hapus").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/sppk/hapus",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
...
function editData(ID){
	...
	$.ajax({
		type	: "POST",
		url		: "<?php echo site_url(); ?>site_user/sppk/cari",
		data	: "cari="+cari,
		dataType: "json",
		success	: function(data){
			//alert(data.ref);
...
//		$data = $this->model_data->data_sppk($username);	
		$data = $this->model_data->data_sppk("user",$username);			
