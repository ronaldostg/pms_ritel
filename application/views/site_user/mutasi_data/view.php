...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/mutasi_data/simpan",
			data	: string,
			cache	: false,
...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/mutasi_data/ajukan",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
...
//		var string = $("#my-form").serialize();
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_user/mutasi_data/hapus",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
...
function editData(ID){
	...
	$.ajax({
		type	: "POST",
		url		: "<?php echo site_url(); ?>site_user/mutasi_data/cari",
		data	: "cari="+cari,
		dataType: "json",
		success	: function(data){
			//alert(data.ref);
...
//		$data = $this->model_data->data_prospek_mutasi($username);
		$data = $this->model_data->data_prospek_mutasi("user",$username);
		$i=1;
        ...
        <div class="row-fluid">
            <form class="form-horizontal" name="my-form" id="my-form">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="kode_status" id="kode_status" class="span5" readonly="true">
                        	<option value="0" selected="selected" readonly="true">Perorangan</option>
                            <option value="1" readonly="true">Perusahaan</option>
                        </select>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="kd_bidang_usaha" id="kd_bidang_usaha" class="span6" readonly="true">
                            <option value="" selected="selected" readonly="true">-Pilih-</option>
                            <?php
