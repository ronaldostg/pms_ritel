...
$(document).ready(function(){
	...
	function cari_data(){
		...
		$.ajax({
			...
			data	: "kd_prodi="+kd_prodi+"&jenjang="+jenjang,
			cache	: false,
...
<div class="widget-box ">
    ...
    <div class="widget-body">
    	<div class="widget-main">
            <div class="row-fluid">
            <form class="form-horizontal" name="my-form" id="my-form" action="<?php echo base_url();?>index.php/lap_dosen/cetak" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="jenjang" id="jenjang" class="span4">
                            	<option value="" selected="selected">-Pilih-</option>
                                <?php
