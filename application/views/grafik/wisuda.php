...
$(function () {
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Wisuda Mahasiswa Th.Akademik <?php echo $th;?>'
            },
            subtitle: {
...
<form name="my-form" id="my-form" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/grafik/wisuda">		    <div class="control-group">    
