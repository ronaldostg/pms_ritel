...
<div class="table-header">
    ...
    <a href="<?php echo base_url();?>index.php/mutasi_mhs/tambah" class="btn btn-small btn-success"  name="tambah" id="tambah">
        <i class="icon-check"></i>
        Tambah Data
    </a>
    <a href="<?php echo site_url();?>/mutasi_mhs" class="btn btn-small btn-info"  >
        ...
        <tr>
            ...
            <td class="td-actions"><center>
            	<div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="<?php echo site_url();?>/mutasi_mhs/edit/<?php echo $dt->id_mutasi;?>" >
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a class="red" href="<?php echo site_url();?>/mutasi_mhs/hapus/<?php echo $dt->id_mutasi;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
