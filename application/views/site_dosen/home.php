				...
				<div class="container-fluid">
					<a href="#" class="brand">
						<small>
                            ...
                            <i class="icon-double-angle-right"></i> HALAMAN DOSEN
                            </span>
						</small>
					</a><!--/.brand-->

					<?php echo $this->load->view('site_dosen/notifikasi');?>
                </div><!--/.container-fluid-->
			</div><!--/.navbar-inner-->
		</div>

		<?php echo $this->view('site_dosen/menu');?>
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						<li>
							...
							<a href="<?php echo base_url();?>index.php/site_dosen/home">Home</a>
							<span class="divider">
