...
<div class="tab-content">
    <div id="profil" class="tab-pane in active">
        <?php echo $this->load->view('site_dosen/profil/form_profil');?>
    </div>
    <div id="foto" class="tab-pane">
        <?php echo $this->load->view('site_dosen/profil/form_foto');?>
    </div>

    <div id="password" class="tab-pane">
        <?php echo $this->load->view('site_dosen/profil/form_pwd');?>
    </div>
