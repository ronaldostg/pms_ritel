                ...
                <td class="td-actions">
                    <center>
                        <div class="hidden-phone visible-desktop action-buttons">
                            ...
                            <a class="red" href="javascript:void(0)" onclick="deletedata('<?=$item->username?>')">
                                <i class="icon-trash bigger-130"></i>
                            </a>
                            <a href="javascript:void(0)" class="tooltip-success" data-rel="tooltip" onclick="updatedata('<?=$item->username?>')" title="Edit">
                                            <span class="green">
                        ...
                        <div class="hidden-desktop visible-phone">
                            <div class="inline position-relative">
                                ...
                                <ul
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" class="tooltip-error" data-rel="tooltip" title="Delete" onclick="deletedata(<?=$item->username?>)">
                                            <span class="red">
