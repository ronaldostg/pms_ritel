    ...
    <div class="span12 infobox-container">
        ...
        <a href="#">
            <div class="infobox infobox-green  ">
                ...
                <div class="infobox-data">
                    <span class="infobox-data-number"><?php echo $this->model_data->jml_data('t_prospek');?> Data</span>
        ...
        <a href="#">
            <div class="infobox infobox-pink  ">
                ...
                <div class="infobox-data">
                    <span class="infobox-data-number"><?php echo $this->model_data->jml_data('t_data_collect');?>
                        Data</span>
        ...
        <a href="#">
            <div class="infobox infobox-red  ">
                ...
                <div class="infobox-data">
                    <span class="infobox-data-number"><?php echo $this->model_data->jml_data('t_analisa');?> Data</span>
    ...
    <a href="<?php echo base_url();?>index.php/sppk">
        ...
        <a href="#">
            <div class="infobox infobox-red  ">
                ...
                <div class="infobox-data">
                    <span class="infobox-data-number"><?php echo $this->model_data->jml_data('t_pk');?> Data</span>
...
//							$jlh_prospekxxx = $this->model_data->sum_data_nominal_tabel("t_prospek","nominal_prospek_awal","admin",$username);


           
			$jlh_prospek = $this->model_data->sum_data_nominal_tabel("t_prospek","nominal_prospek_awal","admin",$username);
			$jlh_target = $this->model_data->sum_data_nominal_tabel("t_target","nominal","admin",$username);
			$jlh_data_coll = $this->model_data->sum_data_nominal_tabel("t_data_collect","nominal","admin",$username);
			$jlh_analisa = $this->model_data->sum_data_nominal_tabel("t_analisa","nominal","admin",$username);
			$jlh_komite = $this->model_data->sum_data_nominal_tabel("t_komite","nominal","admin",$username);
			$jlh_sppk = $this->model_data->sum_data_nominal_tabel("t_sppk","nominal","admin",$username);
			$jlh_pk = $this->model_data->sum_data_nominal_tabel("t_pk","nominal","admin",$username);
			$jlh_on_book = $this->model_data->sum_data_nominal_tabel("t_on_book","nominal","admin",$username);
				...
				
                        ...
                        <tr>
                            ...
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_prospek,0);?></td>
                            <td class="center"><?php echo "30%";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_prospek7,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span">
                            ...
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_target,0);?></td>
                            <td class="center"><?php echo "60%";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_target7,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span">
                            ...
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_data_coll,0);?></td>
                            <td class="center"><?php echo "70%";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_data_coll7,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span">
                            ...
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_analisa,0);?></td>
                            <td class="center"><?php echo "80%";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_analisa7,0);?></td>
                        </tr>
                        <!-- <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span">
                        ...
                        <tr>
                            ...
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_pk,0);?></td>
                            <td class="center"><?php echo "80% + 80% + 60%";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_pk7,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span">
                            ...
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_on_book,0);?></td>
                            <td class="center"><?php echo "0%";?></td>
                            <td style="text-align:right">
                                <strong><?php echo number_format($jlh_jlh_on_book,0);?></strong>
                            </td>
                        </tr>
                        <?php 
                //			$t_sks = $t_sks+$dt->sks;
...
//                            $rp_pelunasan = $this->model_data->ambil_data_rencana_kerja("rp_pelunasan",$username,date("Y"));
				...
				"rp_pelunasan","admin",$username,date("Y"));
                        ...
                        <tr>
                            ...
                            <td class="span" style="text-align:right">
                                <?php echo number_format($rp_target_tumbuh,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span2"><?php echo "Existing Debitur";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($rp_existing_debitur,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span2"><?php echo "Rencana Pelunasan";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($rp_pelunasan,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span2"><?php echo "Wajib Ekspansi";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($rp_target_tumbuh+$rp_pelunasan,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span2"><?php echo "Target OS";?></td>
                            <td class="span" style="text-align:right">
                                <?php echo number_format($rp_target_tumbuh+$rp_existing_debitur,0);?>
                            </td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            ...
                            <td class="span" style="text-align:right">
                                <?php echo number_format($jlh_jlh_on_book,0);?></td>
                        </tr>
                        <tr>
                            <td class="center"><?php echo $i++?></td>
                            <td class="span2"><?php echo "Lebih / Kurang";?></td>
                            <td style="text-align:right">
                                <strong><?php echo number_format($jlh_jlh_on_book-($rp_target_tumbuh+$rp_pelunasan),0);?></strong>
                            </td>
                        </tr>
...
setInterval(() => {
    ...
    window.location.href = 'http://localhost/pms_ritel/home';
