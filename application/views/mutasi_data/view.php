...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/mutasi_data/simpan",
			data	: string,
			cache	: false,
	...
	$("#reject").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/mutasi_data/reject",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
...
function editData(ID){
	...
	$.ajax({
		type	: "POST",
		url		: "<?php echo site_url(); ?>/mutasi_data/cari",
		data	: "cari="+cari,
		dataType: "json",
		success	: function(data){
			//alert(data.ref);
...
//		$data = $this->model_data->data_prospek_supervisi_mutasi($username);
		$data = $this->model_data->data_prospek_mutasi("admin",$username);
		$i=1;
        ...
        <div class="row-fluid">
            <form class="form-horizontal" name="my-form" id="my-form">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select disabled name="id_user" id="id_user" class="span6" readonly="true">
                            <option value="" selected="selected">-Pilih-</option>
                            <?php
