<div class="row-fluid">
    <div class="span12"> 
        ...
        <center>
			...
			if(empty($foto)){
			?>
            <img class="editable" alt="Alex's Avatar" id="avatar2" src="<?php echo base_url();?>assets/foto_user/no_foto.jpg" />
			<?php }else{ ?>
            <img class="editable" alt="Alex's Avatar" id="avatar2" src="<?php echo base_url();?>assets/foto_user/<?php echo $foto;?>" />
            <?php } ?>
        </center>    
        </span>      
    	<form name="form-foto" id="form-foto" action="<?php echo base_url();?>index.php/site_user/profil/simpan_foto" method="post" enctype="multipart/form-data">
