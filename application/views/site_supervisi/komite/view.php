...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_supervisi/komite/simpan",
			data	: string,
			cache	: false,
...
//		}				
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_supervisi/komite/kembalikan",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_supervisi/komite/tolak",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
	...
	$("#hapus").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_supervisi/komite/hapus",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
...
function editData(ID){
	...
	$.ajax({
		type	: "POST",
		url		: "<?php echo site_url(); ?>site_supervisi/komite/cari",
		data	: "cari="+cari,
		dataType: "json",
		success	: function(data){
			//alert(data.ref);
...
//		$data = $this->model_data->data_komite_supervisi($username);	
		$data = $this->model_data->data_komite("supervisi",$username);			
		$i=1;
