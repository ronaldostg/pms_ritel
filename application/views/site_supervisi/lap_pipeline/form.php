...
$(document).ready(function(){
	...
	function cari_data(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_supervisi/lap_pipeline/cari_data",
	...
	$("#view_semua_data_prospek").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_supervisi/lap_pipeline/cari_semua_data_prospek",
			data	: "",
			cache	: false,
			success	: function(data){
				$("#view_detail").html(data);
	...
	$("#cetak_pdf").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>site_supervisi/lap_pipeline/cetak_pdf",
			data	: string,
			cache	: false,
			success	: function(data){
				if(data=='Sukses'){
					window.location.assign("<?php echo site_url();?>site_supervisi/lap_pipeline/print_pdf");
				}else{
					$.gritter.add({
						title: 'Peringatan..!!',
						text: data,
	...
	$("#cetak_excel").click(function(){
		...
		$.ajax({
			...
			success	: function(data){
				if(data=='Sukses'){
					window.location.assign("<?php echo site_url();?>site_supervisi/lap_pipeline/print_excel");
				}else{
					$.gritter.add({
						title: 'Peringatan..!!',
						text: data,
