...
$nama_user = $this->model_data->ambil_data_user("nama_user","supervisi",$username); ?>
<strong> <?php echo "Nama Supervisi : " .$nama_user; ?> </strong>
...
//                            $jlh_on_book = $this->model_data->sum_data_on_book($username);
			...
			$jlh_prospek = $this->model_data->sum_data_nominal_tabel("t_prospek","nominal_prospek_awal","supervisi",$username);
			$jlh_target = $this->model_data->sum_data_nominal_tabel("t_target","nominal","supervisi",$username);
			$jlh_data_coll = $this->model_data->sum_data_nominal_tabel("t_data_collect","nominal","supervisi",$username);
			$jlh_analisa = $this->model_data->sum_data_nominal_tabel("t_analisa","nominal","supervisi",$username);
			$jlh_komite = $this->model_data->sum_data_nominal_tabel("t_komite","nominal","supervisi",$username);
			$jlh_sppk = $this->model_data->sum_data_nominal_tabel("t_sppk","nominal","supervisi",$username);
			$jlh_pk = $this->model_data->sum_data_nominal_tabel("t_pk","nominal","supervisi",$username);
			$jlh_on_book = $this->model_data->sum_data_nominal_tabel("t_on_book","nominal","supervisi",$username);
...
//                            $rp_wajib_expansi = $this->model_data->ambil_data_rencana_kerja("rp_wajib_expansi",$username,date("Y"));
//                            $rp_target_os = $this->model_data->ambil_data_rencana_kerja("rp_target_os",$username,date("Y"));
//                            $rp_potensi_on_book = $this->model_data->ambil_data_rencana_kerja("rp_potensi_on_book",$username,date("Y"));
//                            $rp_lebih_kurang = $this->model_data->ambil_data_rencana_kerja("rp_lebih_kurang",$username,date("Y"));
                
				$rp_target_tumbuh = $this->model_data->ambil_data_nominal_tabel_per_thn("t_rencana_kerja",
				"rp_target_tumbuh","supervisi",$username,date("Y"));
				$rp_existing_debitur = $this->model_data->ambil_data_nominal_tabel_per_thn("t_rencana_kerja",
				"rp_existing_debitur","supervisi",$username,date("Y"));
				$rp_pelunasan = $this->model_data->ambil_data_nominal_tabel_per_thn("t_rencana_kerja",
				"rp_pelunasan","supervisi",$username,date("Y"));
