...
<body>
                ...
                <a href="#" class="brand">
                    <small>
                        ...
                        <span style="font-size:12px">
                            <i class="icon-double-angle-right"></i> HALAMAN SUPERVISI
                        </span>
                    </small>
                </a>
                <!--/.brand-->

                <?php echo $this->load->view('site_supervisi/notifikasi');?>
            </div>
            <!--/.container-fluid-->
        </div>
        <!--/.navbar-inner-->
    ...
    <?php echo $this->view('site_supervisi/menu');?>
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="<?php echo base_url();?>index.php/site_supervisi/home">Home</a>
                    <span class="divider">
