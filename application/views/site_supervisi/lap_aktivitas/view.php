<table  class="table fpTable lcnp table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th class="center" width="10">Alamat</th>
...
//			$ip = $this->model_data->cari_ipk($dt->smt,$dt->nim);
        ...
        <tr>
            ...
            <td class="span2"><?php echo substr($dt->nama_prospek,0,20);?></td>
            <td class="span2"><?php echo substr($dt->alamat_prospek,0,20);?></td>
                     



            <td class="span2"><?php echo substr($dt->nama_bidang_usaha,0,28);?></td>   
            <td class="span" style="text-align:right">  <?php echo number_format($dt->nominal_prospek_awal,0);?></td>
		...
		<?php 
//			$t_sks = $t_sks+$dt->sks;
			$total = $total + $dt->nominal_prospek_awal;
		} 
		//$ip =$t_nilai/$t_sks;
		?>
        <tr>
        	<td colspan="4" class="center"><strong>T o t a l</strong></td>
