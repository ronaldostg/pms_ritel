<table  class="table fpTable lcnp table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th class="center" width="20">No Identitas</th>
            <th class="center" width="20">Lama Usaha (Thn)</th>
            <th class="center" width="20">Bi Checking</th>
            <th class="center" width="20">SIUP</th>
            <th class="center" width="20">Tgl Target Booking</th>
...
//			$ip = $this->model_data->cari_ipk($dt->smt,$dt->nim);
        ...
        <tr>
            ...
            <td class="span2"><?php echo substr($dt->no_identitas,0,28);?></td>
            <td class="span2"><?php echo substr($dt->lm_usaha,0,28);?></td>
            <td class="center"><?php 
					if($dt->bi_checking==1){
						 echo "Baik";
					}else{
			...
			<td class="span2"><?php echo substr(date('d-M-y', strtotime($dt->target_tgl_booking)),0,28);?></td>
