...
//		}
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>index.php/site_supervisi/analisa/simpan",
			data	: string,
			cache	: false,
...
//		}				
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>index.php/site_supervisi/analisa/kembalikan",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>index.php/site_supervisi/analisa/tolak",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
	...
	$("#hapus").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>index.php/site_supervisi/analisa/hapus",
			data	: string,
			cache	: false,
			success	: function(data){
				alert(data);
...
function editData(ID){
	...
	$.ajax({
		type	: "POST",
		url		: "<?php echo site_url(); ?>index.php/site_supervisi/analisa/cari",
		data	: "cari="+cari,
		dataType: "json",
		success	: function(data){
			//alert(data.ref);
...
//		$data = $this->model_data->data_analisa_supervisi($username);	
		$data = $this->model_data->data_analisa("supervisi",$username);		
		$i=1;
        ...
        <div class="row-fluid">
            <form class="form-horizontal" name="my-form" id="my-form">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select disabled name="id_jenis_pembiayaan" id="id_jenis_pembiayaan" class="span6"  readonly="true">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select disabled name="mampu_memenuhi_tagihan" id="mampu_memenuhi_tagihan" class="span5"  readonly="true">
                 ...
                 <div class="control-group">
                    ...
                    <div class="controls">
                        <select disabled name="cukup_agunan" id="cukup_agunan" class="span5"  readonly="true">
                        	<option value="1" selected="selected">Ya</option>
                            <option value="2">Tidak</option>
                            <option value="3">Ya Dengan Catatan</option>
                        </select>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select disabled name="pembiayaan_wajar" id="pembiayaan_wajar" class="span5"  readonly="true">
                        	<option value="1" selected="selected">Ya</option>
                            <option value="2">Tidak</option>
                            <option value="3">Ya Dengan Catatan</option>
                        </select>
