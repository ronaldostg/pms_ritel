...
$(document).ready(function() {
    ...
    $("#stsapprove").on('change', function() {
        ...
        if (stsapprove == '1') {
            ...
            $("#form-tambahan-pengembalian").hide();
            $("#form-tambahan-tolak").hide();
            ...
            $("#form-tambahan-pengembalian").show();
            $("#form-tambahan-tolak").hide();
                ...
                <form class="form-horizontal" name="my-form" id="my-form">
                    ...
                    <div id="tab-5" class="tabs border-r border-l border-b rounded p-4 active">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select disabled name="komite_setuju" id="komite_setuju" class="span5">
                        ...
                        <div id="form-tambahan-tolak" style="display :none;">

                            <div class="control-group">
                                <label class="control-label" for="form-field-1">Catatan Penolakan</label>
