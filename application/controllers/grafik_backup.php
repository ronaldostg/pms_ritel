...
//			$jlh_prospek = $this->model_data->sum_data_prospek_admin();
//			$jlh_target = $this->model_data->sum_data_target_admin();
//			$jlh_data_coll = $this->model_data->sum_data_data_coll_admin();
//			$jlh_analisa = $this->model_data->sum_data_analisa_admin();
//			$jlh_komite = $this->model_data->sum_data_komite_admin();
//			$jlh_sppk = $this->model_data->sum_data_sppk_admin();
//			$jlh_pk = $this->model_data->sum_data_pk_admin();
//			$jlh_on_book = $this->model_data->sum_data_on_book_admin();
...
//				$rp_target_tumbuh = $this->model_data->ambil_data_rencana_kerja_admin("rp_target_tumbuh",date("Y"));
//				$rp_existing_debitur = $this->model_data->ambil_data_rencana_kerja_admin("rp_existing_debitur",date("Y"));
//				$rp_pelunasan = $this->model_data->ambil_data_rencana_kerja_admin("rp_pelunasan",date("Y"));
