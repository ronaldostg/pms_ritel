...
//			$jlh_prospekxx = $this->model_data->sum_data_nominal_tabel("t_prospek","nominal_prospek_awal","admin",$username);
...
//			$sess_data['nama_user'] = $this->model_data->ambil_data_user("nama_user",$username);
			$sess_data['nama_user'] = $this->model_data->ambil_data_user("nama_lengkap","admin",$username);		
//echo $sess_data['nama_user'];
...
//			if($r>0){
				...
				//foreach($data->result() as $t){
					...
					//$w = array(10,25,30,30,80,10,30,35,25);
						...
						$pdf->Cell(190,4,'Nama Admin : '.$nama_user ,0,1,'C');
						$pdf->Ln(5);	
...
//			if($r>0){
            ...
            <p>Nama Admin : <?php echo $nama_user; ?> <p>
            <p></p>
