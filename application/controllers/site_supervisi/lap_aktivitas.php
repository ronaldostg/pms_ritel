...
//	 * TIM : Edy Nasri, Aldi Novialdi Rusdiansyah, Eka Juliananta
	...
	public function index()
	{
		...
		if(!empty($cek) && $level=='supervisi'){
			...
			$d['content']= 'site_supervisi/lap_aktivitas/form';
			...
			if($status_prospek=='Semua'){
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=="Sudah Diapprove"){
						$where = "WHERE status_data='2' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Blm Diapprove"){
						$where = "WHERE status_data='1' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dikembalikan"){
						$where = "WHERE status_data='3' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Dihapus"){
						$where = "WHERE status_data='4' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dihapus"){
						$where = "WHERE status_data='5' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Mutasi"){
						$where = "WHERE status_data='6' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);		
					}elseif($status_kondisi_data=="Ditolak"){
						$where = "WHERE status_data='8' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);											
					}elseif($status_kondisi_data=="Laporan Pipeline"){
						$where = "WHERE status_data=2 AND id_user_supervisi1='$username' AND tampil_pd_laporan=1 ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);											
					}else{
					...
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_target_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view_target',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_target_supervisi $where ");
						$dt['data'] = $q;
					...
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_data_coll_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view_data_coll',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_data_coll_supervisi $where ");
						$dt['data'] = $q;
					...
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_analisa_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view_analisa',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_analisa_supervisi $where ");
						$dt['data'] = $q;
					...
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_komite_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view_komite',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_komite_supervisi $where ");
						$dt['data'] = $q;
					...
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_sppk_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view_sppk',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_sppk_supervisi $where ");
						$dt['data'] = $q;
					...
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_pk_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view_pk',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_pk_supervisi $where ");
						$dt['data'] = $q;
					...
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_on_book_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view_on_book',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' ";
						$q = $this->db->query("SELECT * FROM v_lap_on_book_supervisi $where ");
						$dt['data'] = $q;
				...
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=="Sudah Diapprove"){
						$where = "WHERE status_data='2' AND id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Blm Diapprove"){
						$where = "WHERE status_data='1' AND id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dikembalikan"){
						$where = "WHERE status_data='3' AND id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Dihapus"){
						$where = "WHERE status_data='4' AND id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dihapus"){
						$where = "WHERE status_data='5' AND id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Mutasi"){
						$where = "WHERE status_data='6' AND id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Ditolak"){
						$where = "WHERE status_data='8' AND id_user_supervisi1='$username' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Laporan Pipeline"){
						$where = "WHERE status_data=2 AND id_user_supervisi1='$username' AND tampil_pd_laporan=1 AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);											
					}else{
				...
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						$where = "WHERE id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=="Sudah Diapprove"){
						$where = "WHERE status_data='2' AND id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Blm Diapprove"){
						$where = "WHERE status_data='1' AND id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dikembalikan"){
						$where = "WHERE status_data='3' AND id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Dihapus"){
						$where = "WHERE status_data='4' AND id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dihapus"){
						$where = "WHERE status_data='5' AND id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Mutasi"){
						$where = "WHERE status_data='6' AND id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Ditolak"){
						$where = "WHERE status_data='8' AND id_user_supervisi1='$username' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Laporan Pipeline"){
						$where = "WHERE status_data=2 AND id_user_supervisi1='$username' AND tampil_pd_laporan=1 AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$dt['data'] = $q;
						echo $this->load->view('site_supervisi/lap_aktivitas/view',$dt);											
					}else{
			...
			if($status_prospek=='Semua'){
				...
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						...
						$where = "WHERE status_data=2 AND id_user_supervisi1='$username' AND kode_status='1' AND tampil_pd_laporan=1 ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$r = $q->num_rows();						
					}else{
						echo "Maaf, Tidak Ada data";
				...
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						...
						$where = "WHERE status_data=2 AND id_user_supervisi1='$username' AND kode_status='0' AND tampil_pd_laporan=1 ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek_supervisi $where ");
						$r = $q->num_rows();						
					}else{
						echo "Maaf, Tidak Ada data";
...
//				$this->session->set_flashdata('result_info', '<center>Tidak Ada Data1'.$status_kondisi_data.'</center>');
				...
				redirect('site_supervisi/lap_aktivitas');
				//echo "Maaf Tidak ada data";
			}
		}else{
			redirect('login','refresh');
