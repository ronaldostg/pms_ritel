			...
			if($status_prospek=='Semua'){
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_prospek");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' ";
					...
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_target ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view_target',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' ";
					...
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_data_coll ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view_data_coll',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' ";
					...
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_analisa ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view_analisa',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' ";
					...
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_komite ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view_komite',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' ";
					...
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_sppk ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view_sppk',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' ";
					...
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_pk ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view_pk',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' ";
					...
					if($status_kondisi_data=='Semua'){
						...
						$q = $this->db->query("SELECT * FROM v_lap_on_book ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view_on_book',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' ";
				...
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						$where = "WHERE kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=="Sudah Diapprove"){
						$where = "WHERE status_data='2' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Blm Diapprove"){
						$where = "WHERE status_data='1' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dikembalikan"){
						$where = "WHERE status_data='3' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Dihapus"){
						$where = "WHERE status_data='4' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dihapus"){
						$where = "WHERE status_data='5' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Mutasi"){
						$where = "WHERE status_data='6' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Ditolak"){
						$where = "WHERE status_data='8' AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Laporan Pipeline"){
						$where = "WHERE status_data=2 AND tampil_pd_laporan=1 AND kode_status='1' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);											
					}else{
				...
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						$where = "WHERE kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=='Blm Diajukan'){
						$where = "WHERE status_data='0' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);	
					}elseif($status_kondisi_data=="Sudah Diapprove"){
						$where = "WHERE status_data='2' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Blm Diapprove"){
						$where = "WHERE status_data='1' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dikembalikan"){
						$where = "WHERE status_data='3' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Dihapus"){
						$where = "WHERE status_data='4' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Dihapus"){
						$where = "WHERE status_data='5' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Mohon Mutasi"){
						$where = "WHERE status_data='6' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Ditolak"){
						$where = "WHERE status_data='8' AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);						
					}elseif($status_kondisi_data=="Laporan Pipeline"){
						$where = "WHERE status_data=2 AND tampil_pd_laporan=1 AND kode_status='0' ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$dt['data'] = $q;
						echo $this->load->view('lap_aktivitas/view',$dt);											
					}else{
...
//			$dt['id_user_pic'] = $username;
			...
			$q = $this->db->query("SELECT * FROM v_prospek ");
			$dt['data'] = $q;
			...
			if($status_prospek=='Semua'){
				...
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						...
						$where = "WHERE status_data=2 AND kode_status='1' AND tampil_pd_laporan=1 ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$r = $q->num_rows();						
					}else{
						echo "Maaf, Tidak Ada data";
				...
				if($posisi_data=='Prospek'){
					if($status_kondisi_data=='Semua'){
						...
						$where = "WHERE status_data=2 AND kode_status='0' AND tampil_pd_laporan=1 ";
						$q = $this->db->query("SELECT * FROM v_lap_prospek $where ");
						$r = $q->num_rows();						
					}else{
						echo "Maaf, Tidak Ada data";
